...
__global__ __launch_bounds__(THREAD_NUM) void fused_cgemm_ifft_8(int M, int N, int K, float2 *A, float2 *B, float2 *C, float2 *FFT_output, float2 alpha, float2 beta){
