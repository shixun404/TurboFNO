...
# TurboFNO 2D variants configuration
variants = {
    'TurboFNO_2D_A': 'fusion_variants_benchmark_optimized/2D_A_exp_fft+cgemm+ifft/build/TurboFNO_2D_A',
    'TurboFNO_2D_B': 'fusion_variants_benchmark_optimized/2D_B_exp_fused_fft_cgemm+ifft/build/TurboFNO_2D_B',
    'TurboFNO_2D_C': 'fusion_variants_benchmark_optimized/2D_C_exp_fft+fused_cgemm_ifft/build/TurboFNO_2D_C',
    'TurboFNO_2D_D': 'fusion_variants_benchmark_optimized/2D_D_exp_fused_fft_cgemm_ifft/build/TurboFNO_2D_D',
    'TurboFNO_2D_E': 'fusion_variants_benchmark_optimized/2D_E_baseline/build/TurboFNO_2D_E'
}
...
def parse_config_file(config_path):
    ...
    #     print(f"Config file not found: {config_path}, using default values")
    return {
        'bs_list': [32, 64],
        'DX_list': [128, 256],
        'DY_list': [128, 256],
...
# Load configuration
config = parse_config_file(os.path.join(project_root, 'benchmark_config/problem_size_2d.txt'))

# Create output directories
output_folder = "nsys_profiles_2d"
output_stats_folder = "nsys_stats_2d"
os.makedirs(output_folder, exist_ok=True)
os.makedirs(output_stats_folder, exist_ok=True)

print("TurboFNO 2D Variants Benchmark with nsys")
print("=" * 50)
